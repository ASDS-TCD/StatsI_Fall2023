...
# Level of analysis: individuals (in Ireland)
...
#Some people treat categorical values as quasi-continuous 
#-- needs to be justified 
plot(jitter(df$edlvdie,2),jitter(df$euftf_re,2))
#jitter -- manipulating the data +-2 
#(because points are stacked on top of each other)
#be reasonable and don't use jitter just because your plot is ugly
...
# Fit model (include all of the variables EXCEPT the reference category)
...
#INTERPRETATION: in comparison to junior cycle (+ under control of the other variables, 
#postgrads have 0.43 scale points lower on Euroscepticism...
